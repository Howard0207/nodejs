  ...
  if(v && document.getElementById(s[v-1]).selectedIndex>=0 || !v){
    if(dsy.Exists(str)){
      ...
      for(i=0;i<ar.length;i++){
        ss.options[i]=new Option(ar[i],ar[i])
      }//end for
...
dsy.add('0_30',['乌鲁木齐市','克拉玛依市','吐鲁番地区','哈密地区','昌吉州','博尔塔拉州','巴音郭楞州','阿克苏地区','克孜勒苏柯州','喀什地区','和田地区','伊犁州','塔城地区','阿勒泰地区','石河子市','阿拉尔市','图木舒克市','五家渠市'])
...
function _init_area(){ //初始化函数
  for(var i=0;i<s.length-1;i++){
    document.getElementById(s[i]).onchange=new Function('change('+(1)+')')
  }
  change(0)
}
